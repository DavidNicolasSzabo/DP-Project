...
class AccountTest {
    ...
    void getTotalAmount() {
        Account account = new Account("1234",300, Account.TYPE.RON);
        Account account2 = new Account("12345",500, Account.TYPE.RON);
        Account account3 = new Account("12346",400, Account.TYPE.EUR);
    ...
    @org.junit.jupiter.api.Test
    void depose() {
        Account account = new Account("1234",0, Account.TYPE.RON);
        account.depose(50.0);
    ...
    @org.junit.jupiter.api.Test
    void retrieve() {
        Account account = new Account("1234",100, Account.TYPE.RON);
        account.retrieve(50);
        assertEquals(50,account.amount);
    }
